...
type NewsServiceClient interface {
	...
	GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetResponse], error)
}
...
func (c *newsServiceClient) GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type NewsService_GetAllClient = grpc.ServerStreamingClient[GetResponse]
...
type NewsServiceServer interface {
	...
	GetAll(*emptypb.Empty, grpc.ServerStreamingServer[GetResponse]) error
...
func (UnimplementedNewsServiceServer) GetAll(*emptypb.Empty, grpc.ServerStreamingServer[GetResponse]) error {
...
func _NewsService_GetAll_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(NewsServiceServer).GetAll(m, &grpc.GenericServerStream[emptypb.Empty, GetResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type NewsService_GetAllServer = grpc.ServerStreamingServer[GetResponse]
